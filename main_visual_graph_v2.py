...
PARAM_GRID: Dict[str, List[Any]] = OrderedDict({
    ...
    "graph_knn_k": [10],
    "graph_mu_align": [0.3], # 0.5, 1, 3, 10, 30
    "graph_lambda_rkhs": [1],
    ...
    #"helmert":[True],
    "truncated ":[False],
    "G_type": ["imakura"],#"odc", "imakura", "gep", "targetvec", "nonlinear", "laplacian_nonlinear","individual", "fl", "centralize","odc", "imakura", "targetvec_new", "faster_gep", "individual", "fl", "centralize","odc", "imakura", "targetvec_new", nonlinear", "laplacian_nonlinear
    })
