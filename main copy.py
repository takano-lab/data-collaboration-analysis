...
PARAM_GRID: Dict[str, List[Any]] = OrderedDict({
    ...
    #"helmert":[True],
    "truncated ":[False],
    "G_type": ["nonlinear", "laplacian_nonlinear", "imakura"],#"nonlinear", "laplacian_nonlinear","individual", "fl", "centralize","odc", "imakura", "targetvec_new", "faster_gep", "individual", "fl", "centralize","odc", "imakura", "targetvec_new", nonlinear", "laplacian_nonlinear
    })
